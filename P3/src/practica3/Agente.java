...
public class Agente extends SingleAgent {
    ...
    /**
     * Responde al Controlador (send) enviandole las variables de estado del
     * agente
     *
     * @author Gregorio Carvajal Expósito
     */
    ...
    /**
     * Envia al Server (send) una peticion para que le responda con las
    ...
    /**
     * Manda un mensaje FAILURE al Controlador indicando los motivos del error
     *
     * @author Gregorio Carvajal Expósito
    ...
    /**
     * Solicita (send) al Controlador que le informe de los ConversationID que
     * se van a usar en las comunicaciones
     *
     * @author Gregorio Carvajal Expósito
     */
