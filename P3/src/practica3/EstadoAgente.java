...
public class EstadoAgente {
     ...
     *
     * @param replyWithControlador contiene el codigo con el que se comunicaran
     * ela gente y el controlador
     *
     * @author Miguel Ángel Torres López
     */
     ...
     *
     * @return Devuelve un entero con la cantidad de fuel de la que dispone el
     * agente
     *
     * @author Miguel Ángel Torres López
     */
     ...
     *
     * @return Devuelve un boolean que informa de si el agente esta crasheado o
     * no
     *
     * @author Miguel Ángel Torres López
     */
     ...
     *
     * @return Devuelve un boolean que informa de si el agente está pisando el
     * objetivo
     *
     * @author Miguel Ángel Torres López
     */
     ...
     *
     * @return Devuelve un String con el código que se usara para la
     ...
     *
     * @return Devuelve un Acciones con la siguiente accion que va a ejecutar el
     * agente
     *
     * @author Miguel Ángel Torres López
     */
     ...
     *
     * @param percepcion es la información que tiene el agente de las casillas
     * que le rodean
     *
     * @author Miguel Ángel Torres López
     */
     ...
     *
     * @param pisandoObjetivo nos informa de si el agente está pisando el
     * objetivo o no
     *
     * @author Miguel Ángel Torres López
     */
     ...
     *
     * @param replyWithControlador es el código que se usa para mantener la
     * conversacion con el controlador
     *
     * @author Miguel Ángel Torres López
     */
     ...
     *
     * @return Devuelve un int con la cantidad de combustible que consume el
     * agente en cada movimiento
     *
     * @author Miguel Ángel Torres López
     */
    public int getGasto() {
     ...
     *
     * @return Devuelve un int con la cantidad de casillas que es capaz de ver
     * el agente
     *
     * @author Miguel Ángel Torres López
     */
